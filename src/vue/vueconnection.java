...
public class vueconnection extends JFrame implements ActionListener, KeyListener{
	...
	public vueconnection() {
		...
		this.unPanel.setBackground(new Color(239,216,7));
		...
		this.btSeConnecter.setFont(f2);
		this.btSeConnecter.setText("Se Connecter");
		this.btAnnuler.setFont(f2);
		...
		ImageIcon logo = new ImageIcon ("src/image/logoSite.png");
